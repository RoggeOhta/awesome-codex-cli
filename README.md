...
- [launsion-boop/EchoCoding](https://github.com/launsion-boop/EchoCoding) - Hook-triggered audio layer for Codex CLI with SFX, ambient soundscape, and optional cloud TTS/ASR voice interaction. ![GitHub stars](https://img.shields.io/github/stars/launsion-boop/EchoCoding?style=flat-square)
