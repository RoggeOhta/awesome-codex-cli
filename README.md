...
- [johannesjo/parallel-code](https://github.com/johannesjo/parallel-code) - Desktop app for running Codex CLI, Claude Code, and Gemini CLI agents side by side in git worktrees, with diff review and merge controls. ![GitHub stars](https://img.shields.io/github/stars/johannesjo/parallel-code?style=flat-square)
